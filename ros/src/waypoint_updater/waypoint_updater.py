...
class WaypointUpdater(object):
    ...
    def get_closest_waypoint_idx(self):
        ...
        # Check if closest is infront or behind of ego vehicle
        closest_coord = self.waypoints_2d[closest_idx]
        previous_coord = self.waypoints_2d[closest_idx - 1]

        # Equation for hyperplane ethrough closest_coords
        # check with three points if closest is in front
        ...
        # check if closest waypoint is behind vehicle --> then we take next one
        if val > 0: 
